...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
    ...
    <div class="menu-item px-3">
        <a
            href="stock-transfers/{{ $stock_transfer->to_user_id }}?s_date={{ $stock_transfer->period_from?->format('Y-m-d H:i:s') }}&e_date={{ $stock_transfer->period_to?->format('Y-m-d H:i:s') }}"
    ...
    <!-- <div class="menu-item px-3">
        <a href="#" class="menu-link px-3 text-start text-wrap" data-kt-user-id="{{ $stock_transfer->id }}" data-bs-toggle="modal" data-bs-target="#kt_modal_add_stock_transfer" data-kt-action="update_transfer">
       {{ __('account state') }}
        </a>
    </div> -->
    <!--end::Menu item-->
