    ...
    <div class="card-header pt-5">
        ...
        @if(isset($count_invoices['NOEXPIRED']))
            <div class="card-title d-flex flex-column">
                ...
                <span
                    class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{format_amount($invoice_count) .\App\Helpers\Constants::CURRENCY}}</span>
                <span class="text-white opacity-75 pt-1 fw-semibold fs-6">Montant à recouvrer</span>
