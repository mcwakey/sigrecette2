...
<div class="card card-flush h-xl-100">
    <div class="card-header pt-5">
        <h3 class="card-title align-items-start flex-column">
            ...
            <span class="text-gray-500 mt-1 fw-semibold fs-6">Par matière taxable</span>
        </h3>
            ...
            <ul class="nav" id="kt_chart_widget_8_tabs">
                <li class="nav-item">
                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1 active"
                        ...
                        href="#kt_chart_widget_8_month_tab1_m">Matière taxable</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1"
                       ...
                       href="#kt_chart_widget_8_month_tab2_m">Libelle fiscale</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="card-body pt-6">
        <div class="tab-content">
            <div class="tab-pane fade active show" id="kt_chart_widget_8_month_tab1_m" role="tabpanel">
                <div id="kt_amcharts_30" class="ms-n5 min-h-auto" style="height: 275px"></div>
            </div>
            <div class="tab-pane fade " id="kt_chart_widget_8_month_tab2_m" role="tabpanel">
                <div id="kt_amcharts_label" class="ms-n5 min-h-auto" style="height: 275px"></div>
            </div>
        </div>
    </div>
</div>
