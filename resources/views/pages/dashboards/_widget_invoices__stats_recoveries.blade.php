    ...
    <div class="card-body pt-6">
        <div class="card-title d-flex flex-column">
            <div class="rd-invoice1">
                <span class="fw-bold me-2 lh-1 ls-n2">{{$count_titre}}</span>
            </div>
            <span class="opacity-75 pt-1 fw-semibold fs-6" style="color:#000000;margin-bottom:16px;">Paiements</span>
            <span
                class="fw-bold text-white me-2 lh-1 ls-n2" style="font-size: 32px;">{{ format_amount($titre_total).\App\Helpers\Constants::CURRENCY}}</span>
