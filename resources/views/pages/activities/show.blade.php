<x-default-layout>
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <!--end::Avatar-->
                        <!--begin::Name-->
                        <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">{{ $activity->name }}</a>
                        <!--end::Name-->
                        <!--begin::Position-->
                        <div class="mb-9">
                            {{-- @foreach($user->roles as $role) --}}
                                <!--begin::Badge-->
                                <div class="badge badge-lg badge-light-primary d-inline">{{ $activity->status}}</div>
                                <!--begin::Badge-->
                            {{-- @endforeach --}}
                        </div>
                        <!--end::Position-->
                    ...
                    <div class="d-flex flex-stack fs-4 py-3">
                        ...
                        <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit Taxpayer's details">
                            <a href="#" class="btn btn-sm btn-light-success" data-kt-user-id="{{ $activity->id }}" data-bs-toggle="modal" data-bs-target="#kt_modal_add_taxpayer" data-kt-action="update_row">Edit</a>
                        </span>
                    </div>
                    ...
                    <div id="kt_user_view_details" class="collapse show">
                        <div class="pb-5 fs-6">
                            ...
                            <div class="text-gray-600">{{ $activity->tnif }}</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Mobile Phone</div>
                            <div class="text-gray-600">{{ $activity->mobilephone}}</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Telephone</div>
                            <div class="text-gray-600">{{ $activity->telephone}}</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Email</div>
                            <div class="text-gray-600">
                                <a href="#" class="text-gray-600 text-hover-primary">{{ $activity->email }}</a>
                            </div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Address</div>
                            <div class="text-gray-600">{{ $activity->address }}
                                <br />{{ $activity->erea }},
                            ...
                            <div class="text-gray-600">{{ $activity->Zone_id }}</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Date Joined</div>
                            <div class="text-gray-600">{{ $activity->created_at->format('d M Y') }}</div>
                            <!--begin::Details item-->
                        </div>
                    </div>
                    <!--end::Details content-->
                    ...
                    <div class="card card-flush mb-6 mb-xl-9">
                        ...
                        <div class="card-header mt-6">
                            ...
                            <div class="card-title flex-column">
                                ...
                                <div class="fs-6 fw-semibold text-muted">Long: {{ $activity->longitude}} Lat: {{ $activity->latitude}}</div>
                            </div>
                            <!--end::Card title-->
                            <!--begin::Card toolbar-->
                            <!-- <div class="card-toolbar">
    ...
    {{-- @include('pages/activity/modals/_update-details') --}}
    <!--end::Modal - Update user details-->
    <!--begin::Modal - Add schedule-->
    {{-- @include('pages/activity/modals/_add-schedule') --}}
    <!--end::Modal - Add schedule-->
    <!--begin::Modal - Add one time password-->
    {{-- @include('pages/activity/modals/_add-one-time-password') --}}
    <!--end::Modal - Add one time password-->
    <!--begin::Modal - Update email-->
    {{-- @include('pages/activity/modals/_update-email') --}}
    <!--end::Modal - Update email-->
    <!--begin::Modal - Update password-->
    {{-- @include('pages/activity/modals/_update-password') --}}
    <!--end::Modal - Update password-->
    <!--begin::Modal - Update role-->
    {{-- @include('pages/activity/modals/_update-role') --}}
    <!--end::Modal - Update role-->
    <!--begin::Modal - Add auth app-->
    {{-- @include('pages/activity/modals/_add-auth-app') --}}
    <!--end::Modal - Add auth app-->
    <!--begin::Modal - Add task-->
    {{-- @include('pages/activity/modals/_add-task') --}}
    <!--end::Modal - Add task-->
    <!--end::Modals-->
</x-default-layout>
