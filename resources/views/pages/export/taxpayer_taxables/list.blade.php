    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                var table = $('#export-taxpayer_taxables-table').DataTable();
            ...
            document.getElementById('mySearchInput').addEventListener('keyup', function () {
                window.LaravelDataTables['export-taxpayer_taxables-table'].search(this.value).draw();
            });
            document.addEventListener('livewire:init', function () {
                Livewire.on('success', function () {
                    window.LaravelDataTables['export-taxpayer_taxables-table'].ajax.reload();
                });
            });
        </script>
    @endpush
