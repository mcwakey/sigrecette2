<x-auth-layout>
    ...
    <form class="form w-100" novalidate="novalidate" id="kt_new_password_form" data-kt-redirect-url="{{ route('login') }}" action="{{ route('password.update') }}">
        ...
        <!--begin::Input group--->
        <input hidden class="form-check-input" type="checkbox" name="toc" value="1" checked="true"/>
        <!--end::Input group--->

        <!--begin::Actions-->
        <div class="d-flex flex-wrap justify-content-center pb-lg-0">
            <button type="button" id="kt_new_password_submit" class="btn btn-success me-4">
