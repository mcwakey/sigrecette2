<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('taxations.tickets.index') }}
    @endsection
    ...
    <div class="card">
        ...
        <!--end::Card body-->
                ...
                <!--begin::Modal-->
    <livewire:ticket.add-ticket-modal></livewire:ticket.add-ticket-modal>
                <!--end::Modal-->
    ...
    @push('scripts')
        ...
        <script>
            document.getElementById('mySearchInput').addEventListener('keyup', function () {
                window.LaravelDataTables['tickets-table'].search(this.value).draw();
            });
            document.addEventListener('livewire:init', function () {
                Livewire.on('success', function () {
                    $('#kt_modal_add_ticket').modal('hide');
                    window.LaravelDataTables['tickets-table'].ajax.reload();
                });
            });
        </script>
    @endpush
