<div class="modal fade" id="kt_modal_add_category" tabindex="-1" aria-hidden="true" wire:ignore.self data-bs-backdrop='static'>
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-950px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-5 my-7">
                <!--begin::Form-->
                <form id="kt_modal_add_category_form" class="form" action="#" wire:submit="submit" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    <input type="hidden" wire:model="category_id" name="category_id" />
                    ...
                    <div class="text-center pt-15">
                        ...
                        <button type="submit" class="btn btn-success" data-kt-categorys-modal-action="submit">
