                ...
                email: {
                    validators: {
                        regexp: {
                            regexp: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
                            message:
                                "Cette valeur n'est pas une adresse e-mail valide.",
                        },
                        notEmpty: {
                            message: "L'adresse e-mail est requis.",
                        },
                    },
                },
                password: {
                ...
                if (status == "Valid") {
                    ...
                    axios
                        ...
                        .catch(function (error) {
                            ...
                            // password not change at the first time condition error key << pcgu >>
                            if (errors.pcgu && errors.redirect_url) {
                                redirectUrl = errors.redirect_url;
