...
class ExportTaxablesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('tax_label.code', function (Taxable $taxable) {
    ...
    {
        return $this->builder()
            ->setTableId('export-taxables-table')
    ...
    {
        return [
            Column::make('name')->addClass('d-flex align-items-center')->title(__('taxe')),
            Column::make('tax_label.name')->addClass('d-flex align-items-center')->title(__('taxlabel')),
            Column::make('tax_label.code')->title(__('code'))->name('tax_label.code'),
            ...
            Column::make('updated_at')->title(__('created at'))->addClass('text-nowrap')->visible(false),
