...
class TaxLabelsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (!app()->environment('production')) {
            ...
            $taxLabelNamesDeploy = [
                ['name' => "Ventes de produits finis", 'code' => "	701111",'category'=>"CATEGORY 1"],
                ['name' => "Coupes de bois", 'code' => "701211",'category'=>"CATEGORY 1"],
                ['name' => "Redevances d'enlèvement des ordures et des déchets	", 'code' => "702111",'category'=>"CATEGORY 1"],
                ['name' => "Redevances de vidange et de curage de caniveaux et fosses septiques	", 'code' => "702211",'category'=>"CATEGORY 1"],
                ['name' => "Taxes de désinfection (services d’hygiène)	", 'code' => "702311",'category'=>"CATEGORY 1"],
                ['name' => "Autres recettes de prestations de services	", 'code' => "702911",'category'=>"CATEGORY 1"],
                ['name' => "Variation de stocks de produits	", 'code' => "703111",'category'=>"CATEGORY 1"],
                ['name' => "Taxe d'abattage d'inspection sanitaire des animaux de boucherie 	", 'code' => "704111",'category'=>"CATEGORY 1"],
                ['name' => "produits de l'abattoirs	", 'code' => "704911",'category'=>"CATEGORY 1"],
                ['name' => "Location de matériels 	", 'code' => "705111",'category'=>"CATEGORY 1"],
                ['name' => "Location de mobiliers	", 'code' => "705211",'category'=>"CATEGORY 1"],
                ['name' => "Vente de marchandises	", 'code' => "707111",'category'=>"CATEGORY 1"],
                ['name' => "Autres ventes de produits et services	", 'code' => "709911",'category'=>"CATEGORY 1"],
                ['name' => "Concessions et redevances funéraires	", 'code' => "721111",'category'=>"CATEGORY 1"],
                ['name' => "Taxe sur les pompes distributrices de carburant ", 'code' => "	721211",'category'=>"CATEGORY 1"],
                ...
                ['name' => "Taxes sur la publicité	", 'code' => "721711",'category'=>"CATEGORY 1"],
                ['name' => "Autres revenus du domaine	", 'code' => "721911",'category'=>"CATEGORY 1"],
                ['name' => "Taxe d'expédition, d'enregistrement des actes administratifs et d'état civil	", 'code' => "722111",'category'=>"CATEGORY 1"],
                ['name' => "Redevance d'urbanisme	", 'code' => "722211",'category'=>"CATEGORY 1"],
                ['name' => "Taxes d'inspection sanitaire des produits alimentaires 	", 'code' => "722311",'category'=>"CATEGORY 1"],
                ['name' => "Taxes d'abattage des essences forestières 	", 'code' => "722411",'category'=>"CATEGORY 1"],
                ['name' => "Taxes d'abattage des palmiers à huile 	", 'code' => "722511",'category'=>"CATEGORY 1"],
                ['name' => " Autres droits et frais administratifs	", 'code' => "722911",'category'=>"CATEGORY 1"],
                ['name' => "Droits de place dans les marchés et foires 	", 'code' => "723111",'category'=>"CATEGORY 1"],
                ['name' => "Droits de place des marchands ambulants	", 'code' => "723211",'category'=>"CATEGORY 1"],
                ['name' => "Produit d'exploitation des carrières	", 'code' => "724111",'category'=>"CATEGORY 1"],
                ['name' => "Redevance minière	", 'code' => "724211",'category'=>"CATEGORY 1"],
                ['name' => "Autres  Produits du sol et du sous-sol", 'code' => "724911",'category'=>"CATEGORY 1"],
                ['name' => "Droits de mutations de biens", 'code' => "725111",'category'=>"CATEGORY 1"],
                ['name' => "Droits de permis de stationnement et de parking", 'code' => "726111",'category'=>"CATEGORY 1"],
                ['name' => "Redevance d’occupation du domaine public", 'code' => "726211",'category'=>"CATEGORY 1"],
                ['name' => "Amendes de simple police	", 'code' => "727111",'category'=>"CATEGORY 1"],
                ['name' => "Autres amendes", 'code' => "727911",'category'=>"CATEGORY 1"],
                ['name' => "Produits des quêtes et contributions volontaires	", 'code' => "728111",'category'=>"CATEGORY 1"],
                ['name' => " Autres recettes non fiscales	", 'code' => "729911",'category'=>"CATEGORY 1"],

            ];
            foreach ( $taxLabelNamesDeploy as $item) {
                TaxLabel::create($item);
            }
        }
